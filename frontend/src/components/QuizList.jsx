        ...
        <div>
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                        {quizzes.length > 0 ? `Found ${quizzes.length} quizzes` : 'No quizzes found'}
                    </p>
                </div>
                <button
            ...
            {loading && (
                <div className="text-center py-16">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">Loading amazing quizzes...</p>
                </div>
            )}
            ...
            {error && !loading && (
                <div className="text-center py-16">
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 max-w-md mx-auto">
                        ...
                        <p className="text-red-600 dark:text-red-500 text-sm">Using fallback data for demonstration</p>
                    </div>
                </div>
            )}
            ...
            {!loading && (
                <>
                    <div className={`${isListView ? 'flex flex-col gap-6' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'} transition-all duration-300`}>
